...
namespace DX
{
    ...
    public:
        DeviceResources();
        void SetSwapChain(winrt::Windows::UI::Xaml::Controls::SwapChainPanel const& window);
    ...
    private:
        ...
        winrt::agile_ref<winrt::Windows::UI::Xaml::Controls::SwapChainPanel> m_swapChainPanel{ nullptr };
